...
const FALLBACK_PRODUCTS: Record<string, ProductDetail> = {
  "liquid-chalk": {
    ...
    images: [{ id: 0, path: "", url: "/liquid-chalk-dominate200ml.png", thumbnail_url: "/liquid-chalk-dominate200ml.png", is_primary: true, display_order: 0, variant_ids: [] }],
    variants: [],
    reviews: [],
  },
  "standard-parallettes": {
    ...
    images: [{ id: 0, path: "", url: "/dominate-parallettes-standard.png", thumbnail_url: "/dominate-parallettes-standard.png", is_primary: true, display_order: 0, variant_ids: [] }],
    variants: [],
    reviews: [],
  },
};
