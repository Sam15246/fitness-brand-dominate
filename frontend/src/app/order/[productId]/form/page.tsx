...
export default function LegacyOrderFormPage() {
  ...
  if (!isValidProductId) {
    return (
      <div className="min-h-screen bg-[#0d0b09] px-6 py-14 text-[#f4eee4]">
        <div className="mx-auto max-w-3xl rounded-2xl border border-[#8b6f47]/30 bg-[#15120f]/85 p-7">
          <p className="text-sm text-[#f4c2c2]">Invalid product reference</p>
          <Link href="/products" className="mt-4 inline-block text-sm text-[#d8c19a] hover:text-[#f1ddbe]">
            Back to products
          </Link>
        </div>
      </div>
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#0d0b09] px-6 py-14 text-[#f4eee4]">
        <div className="mx-auto max-w-3xl rounded-2xl border border-[#8b6f47]/30 bg-[#15120f]/85 p-7 text-sm text-[#d4c4a7]">
          Loading order form...
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-[#0d0b09] px-6 py-14 text-[#f4eee4]">
      <div className="mx-auto w-full max-w-3xl rounded-2xl border border-[#8b6f47]/30 bg-[#15120f]/85 p-7">
        <p className="text-xs uppercase tracking-[0.2em] text-[#b59a73]">Legacy Order Form</p>
        <h1 className="text-brand-display mt-2 text-4xl uppercase tracking-[0.04em] text-[#eed8b1]">{product.name}</h1>

        <div className="mt-5 rounded-xl border border-[#8b6f47]/25 bg-[#1a1510] p-4">
          <p className="text-sm text-[#d7c7ad]">Price: {product.price_display}</p>
          <p className="mt-1 text-xs text-[#b59a73]">Choose quantity and continue to checkout.</p>
        </div>

        <div className="mt-5 grid gap-3 md:grid-cols-2">
          <label className="text-sm text-[#d7c7ad]" htmlFor="legacy-order-qty">
            Quantity
            <input
              id="legacy-order-qty"
              type="number"
              ...
              className="mt-1 w-full rounded-lg border border-[#8b6f47]/45 bg-[#1a1510] px-3 py-2 text-sm outline-none focus:border-[#b59a73]"
            />
          </label>

          <label className="text-sm text-[#d7c7ad]" htmlFor="legacy-order-coupon">
          ...
          <label className="text-sm text-[#d7c7ad]" htmlFor="legacy-order-referral">
