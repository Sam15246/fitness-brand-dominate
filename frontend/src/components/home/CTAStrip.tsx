    ...
    <section className="relative overflow-hidden bg-[#0d0b09] py-24 md:py-32">
      ...
      <div className="relative z-10 mx-auto max-w-[1240px] px-5 text-center sm:px-8 lg:px-10">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          <Link
            href="/products"
            className="group relative inline-flex min-h-[52px] items-center justify-center overflow-hidden rounded-full border border-[#c89e65]/45 bg-[#a67126] px-10 py-[15px] text-[11px] font-bold uppercase tracking-[0.16em] text-[#f4eee4] transition-all hover:-translate-y-px hover:shadow-[0_8px_32px_rgba(166,113,38,0.35)]"
          >
          ...
          <Link
            href="/order/status"
            className="inline-flex min-h-[52px] items-center justify-center rounded-full border border-[#a67126]/38 bg-transparent px-10 py-[15px] text-[11px] font-semibold uppercase tracking-[0.16em] text-[#f4eee4]/70 transition-all hover:border-[#a67126]/60 hover:bg-[#a67126]/14 hover:text-[#f4eee4]"
          >
            Track My Order
          </Link>
        </div>
